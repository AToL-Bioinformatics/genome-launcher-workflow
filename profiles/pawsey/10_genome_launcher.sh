...
export SNAKEMAKE_STORAGE_S3_ENDPOINT_URL=${RCLONE_CONFIG_UPLOAD_ENDPOINT}
export SNAKEMAKE_STORAGE_S3_ACCESS_KEY=${RCLONE_CONFIG_UPLOAD_ACCESS_KEY_ID}
export SNAKEMAKE_STORAGE_S3_SECRET_KEY=${RCLONE_CONFIG_UPLOAD_SECRET_ACCESS_KEY}
